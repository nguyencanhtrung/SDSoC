...
proc create_root_design { parentCell } {
  ...
  # Create instance: correlation_accel_v4_0, and set properties
  set correlation_accel_v4_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:correlation_accel_v4:1.0 correlation_accel_v4_0 ]

  # Create instance: correlation_accel_v4_0_if, and set properties
  ...
  set_property -dict [ list CONFIG.C_INPUT_SCALAR_0_WIDTH {32} CONFIG.C_INPUT_SCALAR_1_WIDTH {32} CONFIG.C_N_INPUT_ARGS {0} CONFIG.C_N_INPUT_SCALARS {2} CONFIG.C_N_OUTPUT_ARGS {0}  ] $correlation_accel_v4_0_if
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M00_AXI] [get_bd_intf_pins correlation_accel_v4_0_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_dwc_datamover_0_txd_0_M_AXIS [get_bd_intf_pins axis_dwc_datamover_0_txd_0/M_AXIS] [get_bd_intf_pins correlation_accel_v4_0/in_indices]
  ...
  connect_bd_intf_net -intf_net correlation_accel_v4_0_if_AP_CTRL [get_bd_intf_pins correlation_accel_v4_0/ap_ctrl] [get_bd_intf_pins correlation_accel_v4_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net correlation_accel_v4_0_out_correlation [get_bd_intf_pins axis_dwc_datamover_1_rxd_0/S_AXIS] [get_bd_intf_pins correlation_accel_v4_0/out_correlation]
  ...
  connect_bd_net -net clkid2 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S02_ACLK] [get_bd_pins axis_dwc_datamover_0_txd_0/aclk] [get_bd_pins axis_dwc_datamover_1_rxd_0/aclk] [get_bd_pins axis_rtr_datamover_0/M_AXIS_0_ACLK] [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aclk] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aclk] [get_bd_pins correlation_accel_v4_0/ap_clk] [get_bd_pins correlation_accel_v4_0_if/aclk] [get_bd_pins correlation_accel_v4_0_if/s_axi_aclk] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/m_axi_sg_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_s2mm_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK]
  connect_bd_net -net clkid3 [get_bd_pins proc_sys_reset_3/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK3]
  connect_bd_net -net correlation_accel_v4_0_if_ap_iscalar_0_dout [get_bd_pins correlation_accel_v4_0/number_of_days] [get_bd_pins correlation_accel_v4_0_if/ap_iscalar_0_dout]
  connect_bd_net -net correlation_accel_v4_0_if_ap_iscalar_1_dout [get_bd_pins correlation_accel_v4_0/number_of_indices] [get_bd_pins correlation_accel_v4_0_if/ap_iscalar_1_dout]
  connect_bd_net -net correlation_accel_v4_0_if_aresetn [get_bd_pins correlation_accel_v4_0/ap_rst_n] [get_bd_pins correlation_accel_v4_0_if/aresetn]
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_dwc_datamover_0_txd_0/aresetn] [get_bd_pins axis_dwc_datamover_1_rxd_0/aresetn] [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aresetn] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aresetn] [get_bd_pins correlation_accel_v4_0_if/s_axi_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs correlation_accel_v4_0_if/S_AXI/Reg] SEG_correlation_accel_v4_0_if_Reg
