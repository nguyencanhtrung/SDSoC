...
#---------------------------
# Instantiating sobel_filter_0_if
#---------------------------
...
#---------------------------
connect_bd_net  \
  [get_bd_pins /sharpen_filter_0_if/aresetn] \
  [get_bd_pins /sharpen_filter_0/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins /sharpen_filter_0/ap_return] \
  [get_bd_pins /sharpen_filter_0_if/ap_oscalar_0_din] \

connect_bd_net  \
  [get_bd_pins /sobel_filter_0_if/aresetn] \
  [get_bd_pins /sobel_filter_0/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins /sobel_filter_0/ap_return] \
  [get_bd_pins /sobel_filter_0_if/ap_oscalar_0_din] \
...
connect_bd_net  \
  ...
  [get_bd_pins /sharpen_filter_0/ap_clk] \
  [get_bd_pins /sobel_filter_0/ap_clk] \
  [get_bd_pins /sharpen_filter_0_if/s_axi_aclk] \
  [get_bd_pins /sharpen_filter_0_if/aclk] \
  [get_bd_pins /sharpen_filter_0_if/m_axis_aclk] \
  [get_bd_pins /sharpen_filter_0_if/s_axis_aclk] \
  [get_bd_pins /sobel_filter_0_if/s_axi_aclk] \
  [get_bd_pins /sobel_filter_0_if/aclk] \
  [get_bd_pins /sobel_filter_0_if/m_axis_aclk] \
  ...
  [get_bd_pins /axi_ic_ps7_S_AXI_HP1/S01_ACLK] \
...
connect_bd_net  \
  ...
  [get_bd_pins /axi_ic_ps7_S_AXI_HP1/S01_ARESETN] \
...
connect_bd_net  \
  ...
  [get_bd_pins /sharpen_filter_0_if/s_axi_aresetn] \
  [get_bd_pins /sharpen_filter_0_if/m_axis_aresetn] \
  [get_bd_pins /sharpen_filter_0_if/s_axis_aresetn] \
  [get_bd_pins /sobel_filter_0_if/s_axi_aresetn] \
  [get_bd_pins /sobel_filter_0_if/m_axis_aresetn] \
...
connect_bd_net  \
  [get_bd_pins /dm_3/s2mm_introut] \
  [get_bd_pins /xlconcat/In3] \

connect_bd_intf_net \
  [get_bd_intf_pins /sharpen_filter_0_if/ap_ctrl] \
  [get_bd_intf_pins /sharpen_filter_0/ap_ctrl] \

connect_bd_intf_net \
  [get_bd_intf_pins /sharpen_filter_0/input_r] \
  [get_bd_intf_pins /sharpen_filter_0_if/AP_FIFO_IARG_0] \

connect_bd_intf_net \
  [get_bd_intf_pins /sharpen_filter_0/output_r] \
  [get_bd_intf_pins /sharpen_filter_0_if/AP_FIFO_OARG_0] \

connect_bd_intf_net \
  [get_bd_intf_pins /sobel_filter_0_if/ap_ctrl] \
  [get_bd_intf_pins /sobel_filter_0/ap_ctrl] \

connect_bd_intf_net \
  [get_bd_intf_pins /sobel_filter_0/input_r] \
  [get_bd_intf_pins /sobel_filter_0_if/AP_FIFO_IARG_0] \

connect_bd_intf_net \
  [get_bd_intf_pins /sobel_filter_0/output_r] \
  [get_bd_intf_pins /sobel_filter_0_if/AP_FIFO_OARG_0] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /sharpen_filter_0_if/S_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins /axi_ic_ps7_M_AXI_GP0/M01_AXI] \
  [get_bd_intf_pins /sobel_filter_0_if/S_AXI] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /sharpen_filter_0_if/S_AXIS_0] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /sobel_filter_0_if/S_AXIS_0] \
...
connect_bd_intf_net \
  [get_bd_intf_pins /sharpen_filter_0_if/M_AXIS_0] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /axi_ic_ps7_S_AXI_HP1/S01_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins /sobel_filter_0_if/M_AXIS_0] \
