...
architecture behav of madd is 
    ...
    "madd,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.256000,HLS_SYN_LAT=1033,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=363,HLS_SYN_LUT=502}";
    ...
    component madd_fadd_32ns_32ns_32_5_full_dsp IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    madd_fadd_32ns_32ns_32_5_full_dsp_U0 : component madd_fadd_32ns_32ns_32_5_full_dsp
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it6 = ap_const_lv1_0)) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, exitcond_flatten_fu_140_p2, ap_reg_ppiten_pp0_it0, ap_reg_ppiten_pp0_it1, ap_reg_ppiten_pp0_it7, ap_reg_ppiten_pp0_it8)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_pp0_stg0_fsm_1 => 
                if ((not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it8) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it7)))) and not(((ap_const_logic_1 = ap_reg_ppiten_pp0_it0) and not((exitcond_flatten_fu_140_p2 = ap_const_lv1_0)) and not((ap_const_logic_1 = ap_reg_ppiten_pp0_it1)))))) then
                    ap_NS_fsm <= ap_ST_pp0_stg0_fsm_1;
    ...
    C_Addr_A_orig <= ap_reg_ppstg_tmp_3_reg_237_pp0_it7(32 - 1 downto 0);
    C_Clk_A <= ap_clk;
    C_Din_A <= tmp_4_reg_262;

    -- C_EN_A assign process. --
    C_EN_A_assign_proc : process(ap_reg_ppiten_pp0_it8)
    begin
    ...
    C_WEN_A_assign_proc : process(ap_reg_ppiten_pp0_it8, ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it7)
    begin
        if ((((ap_const_logic_1 = ap_reg_ppiten_pp0_it8) and (ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it7 = ap_const_lv1_0)))) then 
    ...
    ap_done_assign_proc : process(ap_sig_cseq_ST_st11_fsm_2)
    begin
    ...
    begin
                ap_sig_bdd_221 <= (ap_const_lv1_1 = ap_CS_fsm(2 downto 2));
    end process;
    ...
    ap_sig_cseq_ST_st11_fsm_2_assign_proc : process(ap_sig_bdd_221)
    begin
