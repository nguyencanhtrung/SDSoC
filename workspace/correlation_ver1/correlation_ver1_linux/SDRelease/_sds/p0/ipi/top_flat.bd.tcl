...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.M00_HAS_REGSLICE {1} CONFIG.NUM_MI {1} CONFIG.NUM_SI {1} CONFIG.S00_HAS_REGSLICE {1} CONFIG.STRATEGY {0}  ] $axi_interconnect_M_AXI_GP0
  ...
  set_property -dict [ list CONFIG.M00_HAS_DATA_FIFO {2} CONFIG.M00_HAS_REGSLICE {1} CONFIG.NUM_MI {1} CONFIG.NUM_SI {1} CONFIG.S00_HAS_DATA_FIFO {2} CONFIG.S00_HAS_REGSLICE {1} CONFIG.STRATEGY {0}  ] $axi_interconnect_S_AXI_HP0

  # Create instance: correlation_accel_v1_0, and set properties
  set correlation_accel_v1_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:correlation_accel_v1:1.0 correlation_accel_v1_0 ]

  # Create instance: correlation_accel_v1_0_if, and set properties
  ...
  set_property -dict [ list CONFIG.C_INPUT_SCALAR_0_WIDTH {32} CONFIG.C_INPUT_SCALAR_1_WIDTH {32} CONFIG.C_INPUT_SCALAR_2_WIDTH {32} CONFIG.C_INPUT_SCALAR_3_WIDTH {32} CONFIG.C_N_INPUT_ARGS {0} CONFIG.C_N_INPUT_SCALARS {4} CONFIG.C_N_OUTPUT_ARGS {0} CONFIG.C_N_OUTPUT_SCALARS {1} CONFIG.C_OUTPUT_SCALAR_0_WIDTH {32}  ] $correlation_accel_v1_0_if
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  set_property -dict [ list CONFIG.CONST_VAL {0} CONFIG.CONST_WIDTH {1}  ] $ps7_irq_const
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M00_AXI] [get_bd_intf_pins correlation_accel_v1_0_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net correlation_accel_v1_0_if_AP_CTRL [get_bd_intf_pins correlation_accel_v1_0/ap_ctrl] [get_bd_intf_pins correlation_accel_v1_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net correlation_accel_v1_0_m_axi_gmem32 [get_bd_intf_pins axi_interconnect_S_AXI_HP0/S00_AXI] [get_bd_intf_pins correlation_accel_v1_0/m_axi_gmem32]
  ...
  connect_bd_net -net correlation_accel_v1_0_if_ap_iscalar_1_dout [get_bd_pins correlation_accel_v1_0/number_of_indices] [get_bd_pins correlation_accel_v1_0_if/ap_iscalar_1_dout]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces correlation_accel_v1_0/Data_m_axi_gmem32] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs correlation_accel_v1_0_if/S_AXI/Reg] SEG_correlation_accel_v1_0_if_Reg
