...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_net -net clkid2 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S01_ACLK] [get_bd_pins axis_dwc_datamover_0_txd_0/aclk] [get_bd_pins axis_dwc_datamover_1_rxd_0/aclk] [get_bd_pins correlation_accel_v3_0/ap_clk] [get_bd_pins correlation_accel_v3_0_if/aclk] [get_bd_pins correlation_accel_v3_0_if/s_axi_aclk] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_s2mm_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_dwc_datamover_0_txd_0/aresetn] [get_bd_pins axis_dwc_datamover_1_rxd_0/aresetn] [get_bd_pins correlation_accel_v3_0_if/s_axi_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
