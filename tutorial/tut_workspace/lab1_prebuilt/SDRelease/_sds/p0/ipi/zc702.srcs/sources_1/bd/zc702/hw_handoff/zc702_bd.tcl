...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.M00_HAS_DATA_FIFO {2} CONFIG.M00_HAS_REGSLICE {1} CONFIG.NUM_MI {1} CONFIG.NUM_SI {4} CONFIG.S00_HAS_DATA_FIFO {2} CONFIG.S00_HAS_REGSLICE {1} CONFIG.S01_HAS_DATA_FIFO {2} CONFIG.S01_HAS_REGSLICE {1} CONFIG.S02_HAS_DATA_FIFO {2} CONFIG.S02_HAS_REGSLICE {1} CONFIG.S03_HAS_DATA_FIFO {2} CONFIG.S03_HAS_REGSLICE {1} CONFIG.STRATEGY {2}  ] $axi_interconnect_S_AXI_ACP
  ...
  set_property -dict [ list CONFIG.c_dlytmr_resolution {1250} CONFIG.c_include_mm2s {1} CONFIG.c_include_mm2s_dre {1} CONFIG.c_include_mm2s_sf {1} CONFIG.c_include_s2mm {0} CONFIG.c_include_sg {0} CONFIG.c_m_axi_mm2s_data_width {64} CONFIG.c_m_axis_mm2s_tdata_width {64} CONFIG.c_mm2s_burst_size {64} CONFIG.c_sg_length_width {23}  ] $datamover_2
...
CONFIG.PCW_FCLK3_PERIPHERAL_CLKSRC {IO PLL} CONFIG.PCW_FCLK_CLK1_BUF {true} \
...
CONFIG.PCW_FPGA_FCLK3_ENABLE {1} CONFIG.PCW_GPIO_EMIO_GPIO_ENABLE {0} \
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M00_AXI] [get_bd_intf_pins madd_0_if/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M01_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M01_AXI] [get_bd_intf_pins mmult_0_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net datamover_0_M_AXIS_MM2S [get_bd_intf_pins datamover_0/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_1]
  connect_bd_intf_net -intf_net datamover_0_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S00_AXI] [get_bd_intf_pins datamover_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net datamover_1_M_AXIS_MM2S [get_bd_intf_pins datamover_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_0]
  connect_bd_intf_net -intf_net datamover_1_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S01_AXI] [get_bd_intf_pins datamover_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net datamover_2_M_AXIS_MM2S [get_bd_intf_pins datamover_2/M_AXIS_MM2S] [get_bd_intf_pins madd_0_if/S_AXIS_1]
  connect_bd_intf_net -intf_net datamover_2_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S02_AXI] [get_bd_intf_pins datamover_2/M_AXI_MM2S]
  connect_bd_intf_net -intf_net datamover_3_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S03_AXI] [get_bd_intf_pins datamover_3/M_AXI_S2MM]
  connect_bd_intf_net -intf_net madd_0_A_PORTA [get_bd_intf_pins madd_0/A_PORTA] [get_bd_intf_pins madd_0_if/AP_BRAM_IARG_0]
  connect_bd_intf_net -intf_net madd_0_B_PORTA [get_bd_intf_pins madd_0/B_PORTA] [get_bd_intf_pins madd_0_if/AP_BRAM_IARG_1]
  connect_bd_intf_net -intf_net madd_0_C_PORTA [get_bd_intf_pins madd_0/C_PORTA] [get_bd_intf_pins madd_0_if/AP_BRAM_OARG_0]
  connect_bd_intf_net -intf_net madd_0_if_AP_CTRL [get_bd_intf_pins madd_0/ap_ctrl] [get_bd_intf_pins madd_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net madd_0_if_M_AXIS_0 [get_bd_intf_pins datamover_3/S_AXIS_S2MM] [get_bd_intf_pins madd_0_if/M_AXIS_0]
  connect_bd_intf_net -intf_net mmult_0_if_AP_CTRL [get_bd_intf_pins mmult_0/ap_ctrl] [get_bd_intf_pins mmult_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net mmult_0_if_M_AXIS_0 [get_bd_intf_pins madd_0_if/S_AXIS_0] [get_bd_intf_pins mmult_0_if/M_AXIS_0]
  connect_bd_intf_net -intf_net mmult_0_in_A [get_bd_intf_pins mmult_0/in_A] [get_bd_intf_pins mmult_0_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net mmult_0_in_B [get_bd_intf_pins mmult_0/in_B] [get_bd_intf_pins mmult_0_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net mmult_0_out_C [get_bd_intf_pins mmult_0/out_C] [get_bd_intf_pins mmult_0_if/AP_FIFO_OARG_0]
  ...
  connect_bd_net -net acp_axcache_0xF_dout [get_bd_pins acp_axcache_0xF/dout] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_AXI_awcache]
  ...
  connect_bd_net -net clkid2 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M04_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M05_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_ACLK] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_mm2s_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins datamover_2/m_axi_mm2s_aclk] [get_bd_pins datamover_2/s_axi_lite_aclk] [get_bd_pins datamover_3/m_axi_s2mm_aclk] [get_bd_pins datamover_3/s_axi_lite_aclk] [get_bd_pins madd_0/ap_clk] [get_bd_pins madd_0_if/aclk] [get_bd_pins madd_0_if/m_axis_aclk] [get_bd_pins madd_0_if/s_axi_aclk] [get_bd_pins madd_0_if/s_axis_aclk] [get_bd_pins mmult_0/ap_clk] [get_bd_pins mmult_0_if/aclk] [get_bd_pins mmult_0_if/m_axis_aclk] [get_bd_pins mmult_0_if/s_axi_aclk] [get_bd_pins mmult_0_if/s_axis_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  connect_bd_net -net datamover_2_mm2s_introut [get_bd_pins datamover_2/mm2s_introut] [get_bd_pins xlconcat/In2]
  connect_bd_net -net datamover_3_s2mm_introut [get_bd_pins datamover_3/s2mm_introut] [get_bd_pins xlconcat/In3]
  connect_bd_net -net madd_0_if_aresetn [get_bd_pins madd_0/ap_rst_n] [get_bd_pins madd_0_if/aresetn]
  connect_bd_net -net mmult_0_if_aresetn [get_bd_pins mmult_0/ap_rst_n] [get_bd_pins mmult_0_if/aresetn]
  connect_bd_net -net proc_sys_reset_2_interconnect_aresetn [get_bd_pins axi_interconnect_M_AXI_GP0/ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M05_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins datamover_2/axi_resetn] [get_bd_pins datamover_3/axi_resetn] [get_bd_pins madd_0_if/m_axis_aresetn] [get_bd_pins madd_0_if/s_axi_aresetn] [get_bd_pins madd_0_if/s_axis_aresetn] [get_bd_pins mmult_0_if/m_axis_aresetn] [get_bd_pins mmult_0_if/s_axi_aresetn] [get_bd_pins mmult_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_0/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_0/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_1/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_1/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs madd_0_if/S_AXI/Reg] SEG_madd_0_if_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs mmult_0_if/S_AXI/Reg] SEG_mmult_0_if_Reg
