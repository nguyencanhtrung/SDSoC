...
This project shows how to build a shared library using APFCC for later use in
...
After building the project, these files will be generated:
 + libmmult_accel.so - Shared library suitable for linking using GCC and for
                       runtime use
...
The 'use' directory contains:
 ...
 + lib/libmmult_accel.so - Copy of file generated on the 'build' directory
