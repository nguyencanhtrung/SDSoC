...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_intf_net -intf_net mmult_accel_0_in_A_PORTA [get_bd_intf_pins mmult_accel_0/in_A_PORTA] [get_bd_intf_pins mmult_accel_0_if/AP_BRAM_IARG_0]
  connect_bd_intf_net -intf_net mmult_accel_0_in_B_PORTA [get_bd_intf_pins mmult_accel_0/in_B_PORTA] [get_bd_intf_pins mmult_accel_0_if/AP_BRAM_IARG_1]
  connect_bd_intf_net -intf_net mmult_accel_0_out_C_PORTA [get_bd_intf_pins mmult_accel_0/out_C_PORTA] [get_bd_intf_pins mmult_accel_0_if/AP_BRAM_OARG_0]
  ...
  connect_bd_net -net proc_sys_reset_2_interconnect_aresetn [get_bd_pins axi_interconnect_M_AXI_GP0/ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aresetn] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins mmult_accel_0_if/m_axis_aresetn] [get_bd_pins mmult_accel_0_if/s_axi_aresetn] [get_bd_pins mmult_accel_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_0/Data_SG] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x0 [get_bd_addr_spaces datamover_0/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_0/Data_SG] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
  ...
  create_bd_addr_seg -range 0x1000000 -offset 0xFC000000 [get_bd_addr_spaces datamover_0/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_ps7_ACP_QSPI_LINEAR
