/* File: /home/trungnguyen/SDSoC/tutorial/tut_workspace/matrix_mult_lab2/SDDebug/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
axi_dma_sg_transaction_info_t _p0_swinst_mmult_0_out_C_info = {
...
struct _p0_swblk_mmult _p0_swinst_mmult_0 = {
  ...
  .in_B = { .base = { 
		...
		.send_i = &axi_dma_simple_send_i },
  .out_C = { .base = { 
		.channel_info = &_p0_swinst_mmult_0_out_C_info, 
...
void _p0_cf_framework_open(int first)
{
  ...
  _p0_cf_open_port( &_p0_swinst_mmult_0.out_C.base );
}
...
void _p0_cf_framework_close(int last)
{
  ...
  cf_close_i( &_p0_swinst_mmult_0.out_C, NULL);
