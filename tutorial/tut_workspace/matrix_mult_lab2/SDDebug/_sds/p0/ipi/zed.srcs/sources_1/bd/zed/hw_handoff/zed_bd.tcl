...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.M00_HAS_REGSLICE {1} CONFIG.M01_HAS_REGSLICE {1} CONFIG.M02_HAS_REGSLICE {1} CONFIG.M03_HAS_REGSLICE {1} CONFIG.NUM_MI {4} CONFIG.NUM_SI {1} CONFIG.S00_HAS_REGSLICE {1} CONFIG.STRATEGY {2}  ] $axi_interconnect_M_AXI_GP0
  ...
  set_property -dict [ list CONFIG.C_M_AXIS_RXD_TDATA_WIDTH {64} CONFIG.C_M_AXIS_TDATA_WIDTH {64} CONFIG.C_NUM_MASTER_SLOTS {0} CONFIG.C_NUM_SLAVE_SLOTS {1} CONFIG.C_S_AXIS_TDATA_WIDTH {64} CONFIG.C_S_AXIS_TXD_TDATA_WIDTH {64}  ] $axis_rtr_datamover_0
  ...
  set_property -dict [ list CONFIG.c_dlytmr_resolution {1250} CONFIG.c_include_mm2s {0} CONFIG.c_include_s2mm {1} CONFIG.c_include_s2mm_dre {1} CONFIG.c_include_s2mm_sf {1} CONFIG.c_include_sg {1} CONFIG.c_m_axi_s2mm_data_width {64} CONFIG.c_s2mm_burst_size {64} CONFIG.c_s_axis_s2mm_tdata_width {64} CONFIG.c_sg_include_stscntrl_strm {1} CONFIG.c_sg_length_width {23} CONFIG.c_sg_use_stsapp_length {0}  ] $datamover_0
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {3}  ] $xlconcat

  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M00_AXI] [get_bd_intf_pins mmult_0_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M02_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M02_AXI] [get_bd_intf_pins datamover_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M03_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M03_AXI] [get_bd_intf_pins datamover_2/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net datamover_0_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S01_AXI] [get_bd_intf_pins datamover_0/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net datamover_1_M_AXIS_MM2S [get_bd_intf_pins datamover_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_1]
  connect_bd_intf_net -intf_net datamover_1_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S02_AXI] [get_bd_intf_pins datamover_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net datamover_2_M_AXIS_MM2S [get_bd_intf_pins datamover_2/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_0]
  connect_bd_intf_net -intf_net datamover_2_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S03_AXI] [get_bd_intf_pins datamover_2/M_AXI_MM2S]
  connect_bd_intf_net -intf_net mmult_0_if_AP_CTRL [get_bd_intf_pins mmult_0/ap_ctrl] [get_bd_intf_pins mmult_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net mmult_0_if_M_AXIS_0 [get_bd_intf_pins axis_rtr_datamover_0/S_AXIS_0] [get_bd_intf_pins mmult_0_if/M_AXIS_0]
  ...
  connect_bd_net -net acp_axcache_0xF_dout [get_bd_pins acp_axcache_0xF/dout] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_AXI_awcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_AXI_arcache]
  connect_bd_net -net clkid0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK0]
  connect_bd_net -net clkid1 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_ACLK] [get_bd_pins axis_rtr_datamover_0/S_AXIS_0_ACLK] [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aclk] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aclk] [get_bd_pins datamover_0/m_axi_s2mm_aclk] [get_bd_pins datamover_0/m_axi_sg_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_mm2s_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins datamover_2/m_axi_mm2s_aclk] [get_bd_pins datamover_2/s_axi_lite_aclk] [get_bd_pins mmult_0/ap_clk] [get_bd_pins mmult_0_if/aclk] [get_bd_pins mmult_0_if/m_axis_aclk] [get_bd_pins mmult_0_if/s_axi_aclk] [get_bd_pins mmult_0_if/s_axis_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  connect_bd_net -net datamover_0_s2mm_introut [get_bd_pins datamover_0/s2mm_introut] [get_bd_pins xlconcat/In0]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aresetn] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aresetn] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins datamover_2/axi_resetn] [get_bd_pins mmult_0_if/m_axis_aresetn] [get_bd_pins mmult_0_if/s_axi_aresetn] [get_bd_pins mmult_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs mmult_0_if/S_AXI/Reg] SEG_mmult_0_if_Reg
