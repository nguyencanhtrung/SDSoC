/* File: /home/trungnguyen/SDSoC/tutorial/tut_workspace/matrix_mult_lab1/SDRelease/_sds/p0/.cf_work/devreg.c */
#include "cf_lib.h"
...
void _p0_cf_register(int first)
{
  ...
  if (xlnk_init_done == 0) {
    ...
    accel_register(&_sds__p0_madd_0);
...
void _p0_cf_unregister(int last)
{
  ...
  accel_unregister(&_sds__p0_madd_0);
