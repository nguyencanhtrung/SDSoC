...
(* CORE_GENERATION_INFO="madd,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=8.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.256000,HLS_SYN_LAT=1033,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=363,HLS_SYN_LUT=502}" *)
...
madd_fadd_32ns_32ns_32_5_full_dsp #(
    .ID( 1 ),
    .NUM_STAGE( 5 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
madd_fadd_32ns_32ns_32_5_full_dsp_U0(
    .clk( ap_clk ),
    .reset( ap_rst_n_inv ),
    .din0( grp_fu_136_p0 ),
    .din1( grp_fu_136_p1 ),
...
always @(posedge ap_clk)
begin
    if ((ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it6 == ap_const_lv1_0)) begin
...
always @ (ap_reg_ppiten_pp0_it8 or ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it7)
begin
    if (((ap_const_logic_1 == ap_reg_ppiten_pp0_it8) & (ap_reg_ppstg_exitcond_flatten_reg_213_pp0_it7 == ap_const_lv1_0))) begin
...
always @ (ap_sig_cseq_ST_st11_fsm_2)
begin
...
always @ (ap_start or ap_CS_fsm or exitcond_flatten_fu_140_p2 or ap_reg_ppiten_pp0_it0 or ap_reg_ppiten_pp0_it1 or ap_reg_ppiten_pp0_it7 or ap_reg_ppiten_pp0_it8)
begin
    case (ap_CS_fsm)
        ap_ST_st1_fsm_0 : 
        begin
        ...
        begin
            if ((~((ap_const_logic_1 == ap_reg_ppiten_pp0_it8) & ~(ap_const_logic_1 == ap_reg_ppiten_pp0_it7)) & ~((ap_const_logic_1 == ap_reg_ppiten_pp0_it0) & ~(exitcond_flatten_fu_140_p2 == ap_const_lv1_0) & ~(ap_const_logic_1 == ap_reg_ppiten_pp0_it1)))) begin
                ap_NS_fsm = ap_ST_pp0_stg0_fsm_1;
...
assign C_Addr_A_orig = ap_reg_ppstg_tmp_3_reg_237_pp0_it7;
...
always @ (ap_CS_fsm)
begin
    ap_sig_bdd_221 = (ap_const_lv1_1 == ap_CS_fsm[ap_const_lv32_2]);
end
