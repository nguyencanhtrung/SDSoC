...
proc init_gui { IPINST } {
	...
	set tabgroup1 [ipgui::add_group $IPINST -parent $Page0 -name {m axi gmem32 (AXI4 Master Interface)} -layout vertical]
	set C_M_AXI_GMEM32_ID_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_ID_WIDTH]
	set C_M_AXI_GMEM32_DATA_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_DATA_WIDTH]
	set C_M_AXI_GMEM32_ENABLE_USER_PORTS [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_ENABLE_USER_PORTS]
	set C_M_AXI_GMEM32_AWUSER_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_AWUSER_WIDTH]
	set C_M_AXI_GMEM32_WUSER_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_WUSER_WIDTH]
	set C_M_AXI_GMEM32_BUSER_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_BUSER_WIDTH]
	set C_M_AXI_GMEM32_ARUSER_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_ARUSER_WIDTH]
	set C_M_AXI_GMEM32_RUSER_WIDTH [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_RUSER_WIDTH]
	set C_M_AXI_GMEM32_USER_VALUE [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_USER_VALUE]
	set C_M_AXI_GMEM32_PROT_VALUE [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_PROT_VALUE]
	set C_M_AXI_GMEM32_CACHE_VALUE [ipgui::add_param $IPINST -parent $tabgroup1 -name C_M_AXI_GMEM32_CACHE_VALUE]
}
