...
CONFIG.NUM_PORTS {4} \
  ...
  connect_bd_intf_net -intf_net axi_ic_ps7_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_ic_ps7_M_AXI_GP0/M00_AXI] [get_bd_intf_pins madd_0_if/S_AXI]
  connect_bd_intf_net -intf_net axi_ic_ps7_M_AXI_GP0_M01_AXI [get_bd_intf_pins axi_ic_ps7_M_AXI_GP0/M01_AXI] [get_bd_intf_pins mmult_0_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXIS_MM2S [get_bd_intf_pins dm_0/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXIS_MM2S [get_bd_intf_pins dm_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_0_if/S_AXIS_0]
  ...
  connect_bd_intf_net -intf_net dm_2_M_AXIS_MM2S [get_bd_intf_pins dm_2/M_AXIS_MM2S] [get_bd_intf_pins madd_0_if/S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net madd_0_A [get_bd_intf_pins madd_0/A] [get_bd_intf_pins madd_0_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net madd_0_B [get_bd_intf_pins madd_0/B] [get_bd_intf_pins madd_0_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net madd_0_C [get_bd_intf_pins madd_0/C] [get_bd_intf_pins madd_0_if/AP_FIFO_OARG_0]
  connect_bd_intf_net -intf_net madd_0_if_AP_CTRL [get_bd_intf_pins madd_0/ap_ctrl] [get_bd_intf_pins madd_0_if/AP_CTRL]
  connect_bd_intf_net -intf_net madd_0_if_M_AXIS_0 [get_bd_intf_pins dm_3/S_AXIS_S2MM] [get_bd_intf_pins madd_0_if/M_AXIS_0]
  ...
  connect_bd_net -net dm_2_mm2s_introut [get_bd_pins dm_2/mm2s_introut] [get_bd_pins xlconcat/In2]
  connect_bd_net -net dm_3_s2mm_introut [get_bd_pins dm_3/s2mm_introut] [get_bd_pins xlconcat/In3]
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_ic_ps7_M_AXI_GP0/ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/M05_ARESETN] [get_bd_pins axi_ic_ps7_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S02_ARESETN] [get_bd_pins axi_ic_ps7_S_AXI_ACP/S03_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins dm_3/axi_resetn] [get_bd_pins madd_0_if/m_axis_aresetn] [get_bd_pins madd_0_if/s_axi_aresetn] [get_bd_pins madd_0_if/s_axis_aresetn] [get_bd_pins mmult_0_if/m_axis_aresetn] [get_bd_pins mmult_0_if/s_axi_aresetn] [get_bd_pins mmult_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces dm_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x400000 -offset 0xE0000000 [get_bd_addr_spaces dm_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_IOP] SEG_ps7_ACP_IOP
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces dm_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x400000 -offset 0xE0000000 [get_bd_addr_spaces dm_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_IOP] SEG_ps7_ACP_IOP
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40430000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs dm_3/S_AXI_LITE/Reg] SEG_dm_3_Reg
