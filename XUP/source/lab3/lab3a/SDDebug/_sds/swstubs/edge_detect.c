...
extern "C" {
#endif
int _p0_sobel_filter_0(uint8_t * input, uint8_t * output);
#ifdef __cplusplus
}
#endif
int _p0_sobel_filter_0(uint8_t * input, uint8_t * output)
{
  ...
  cf_request_handle_t _p0_swinst_sobel_filter_0_cmd;
  cf_send_i(&(_p0_swinst_sobel_filter_0.cmd_sobel_filter), start_seq, 3*sizeof(int), &_p0_swinst_sobel_filter_0_cmd);
  cf_wait(_p0_swinst_sobel_filter_0_cmd);

  cf_send_i(&(_p0_swinst_sobel_filter_0.input_r), input, 2073600 * 1, &_p0_request_3);

  int _p0_sobel_filter_0_v_return;
  cf_receive_i(&(_p0_swinst_sobel_filter_0.output_r), output, 2073600 * 1, &_p0_sobel_filter_0_num_output_r, &_p0_request_4);
  cf_receive_i(&(_p0_swinst_sobel_filter_0.ap_return), &_p0_sobel_filter_0_v_return, 4, &_p0_sobel_filter_0_num_ap_return, &_p0_request_5);
  ...
  return _p0_sobel_filter_0_v_return;
}
