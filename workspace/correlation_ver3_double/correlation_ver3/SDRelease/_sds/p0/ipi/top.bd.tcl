...
set_property -dict [ list \
  ...
  ] $correlation_accel_v2_0_if

#---------------------------
# Instantiating correlation_accel_v2_1_if
#---------------------------
...
#---------------------------
# Instantiating axis_dwc_datamover_1_txd_0
#---------------------------
...
set_property -dict [ list \
  CONFIG.M_TDATA_NUM_BYTES {4} \
  CONFIG.S_TDATA_NUM_BYTES {8} \
  ] $axis_dwc_datamover_1_txd_0

#---------------------------
# Instantiating axis_dwc_datamover_2_rxd_0
#---------------------------
...
set_property -dict [ list \
  ...
  ] $axis_dwc_datamover_2_rxd_0

#---------------------------
# Instantiating axis_dwc_datamover_3_rxd_0
#---------------------------
...
set_property -dict [ list \
  CONFIG.M_TDATA_NUM_BYTES {8} \
  CONFIG.S_TDATA_NUM_BYTES {4} \
  ] $axis_dwc_datamover_3_rxd_0

#---------------------------
# Connectivity
#---------------------------
connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_0_if/aresetn] \
  [get_bd_pins /correlation_accel_v2_0/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_0_if/ap_iscalar_0_dout] \
  [get_bd_pins /correlation_accel_v2_0/number_of_days] \

connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_0_if/ap_iscalar_1_dout] \
  [get_bd_pins /correlation_accel_v2_0/number_of_indices] \

connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_1_if/aresetn] \
  [get_bd_pins /correlation_accel_v2_1/ap_rst_n] \

connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_1_if/ap_iscalar_0_dout] \
  [get_bd_pins /correlation_accel_v2_1/number_of_days] \

connect_bd_net  \
  [get_bd_pins /correlation_accel_v2_1_if/ap_iscalar_1_dout] \
  [get_bd_pins /correlation_accel_v2_1/number_of_indices] \
...
connect_bd_net  \
  ...
  [get_bd_pins /correlation_accel_v2_0/ap_clk] \
  [get_bd_pins /correlation_accel_v2_1/ap_clk] \
  [get_bd_pins /correlation_accel_v2_0_if/s_axi_aclk] \
  [get_bd_pins /correlation_accel_v2_0_if/aclk] \
  [get_bd_pins /correlation_accel_v2_1_if/s_axi_aclk] \
  [get_bd_pins /correlation_accel_v2_1_if/aclk] \
  ...
  [get_bd_pins /axis_dwc_datamover_1_txd_0/aclk] \
  [get_bd_pins /axis_dwc_datamover_2_rxd_0/aclk] \
  [get_bd_pins /axis_dwc_datamover_3_rxd_0/aclk] \
...
connect_bd_net  \
  ...
  [get_bd_pins /correlation_accel_v2_1_if/s_axi_aresetn] \
  [get_bd_pins /axis_dwc_datamover_0_txd_0/aresetn] \
  [get_bd_pins /axis_dwc_datamover_1_txd_0/aresetn] \
  [get_bd_pins /axis_dwc_datamover_2_rxd_0/aresetn] \
  [get_bd_pins /axis_dwc_datamover_3_rxd_0/aresetn] \
...
connect_bd_intf_net \
  [get_bd_intf_pins /correlation_accel_v2_0_if/ap_ctrl] \
  [get_bd_intf_pins /correlation_accel_v2_0/ap_ctrl] \

connect_bd_intf_net \
  [get_bd_intf_pins /correlation_accel_v2_1_if/ap_ctrl] \
  [get_bd_intf_pins /correlation_accel_v2_1/ap_ctrl] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /correlation_accel_v2_0_if/S_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins /axi_interconnect_M_AXI_GP0/M01_AXI] \
  [get_bd_intf_pins /correlation_accel_v2_1_if/S_AXI] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /correlation_accel_v2_1/in_indices] \
...
connect_bd_intf_net \
  ...
  [get_bd_intf_pins /axis_dwc_datamover_1_txd_0/S_AXIS] \

connect_bd_intf_net \
  [get_bd_intf_pins /axis_dwc_datamover_1_txd_0/M_AXIS] \
  [get_bd_intf_pins /correlation_accel_v2_0/in_indices] \
...
connect_bd_intf_net \
  [get_bd_intf_pins /correlation_accel_v2_0/out_correlation] \
  [get_bd_intf_pins /axis_dwc_datamover_2_rxd_0/S_AXIS] \

connect_bd_intf_net \
  [get_bd_intf_pins /axis_dwc_datamover_2_rxd_0/M_AXIS] \
...
connect_bd_intf_net \
  [get_bd_intf_pins /correlation_accel_v2_1/out_correlation] \
  [get_bd_intf_pins /axis_dwc_datamover_3_rxd_0/S_AXIS] \

connect_bd_intf_net \
  [get_bd_intf_pins /axis_dwc_datamover_3_rxd_0/M_AXIS] \
