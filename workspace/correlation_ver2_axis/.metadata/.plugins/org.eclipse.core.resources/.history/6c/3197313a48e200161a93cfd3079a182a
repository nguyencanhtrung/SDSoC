/* File: /wrk/hdstaff/tshui/work1/XIDANE_DEV/regression/products/xidane/platforms/prebuilt/generate/zed/TEST_WORK_lnx64/add_gen_prebuilt/apf/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
#ifdef __linux__
    char buf[128];
    sprintf(buf, "cat /mnt/_sds/_p0_.bin > /dev/xdevcfg");
    system(buf);
#endif
