set moduleName correlation_accel_v2
...
set isOneStateSeq 0
set C_modelName correlation_accel_v2
...
set portList { 
	...
	{ in_indices_TVALID sc_in sc_logic 1 invld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_indices_TVALID", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "in_indices_data_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	in_indices_data_V { axis {  { in_indices_TDATA in_data 0 32 }  { in_indices_TVALID in_vld 0 1 } } }
	...
	in_indices_dest_V { axis {  { in_indices_TREADY in_acc 1 1 }  { in_indices_TDEST in_data 0 1 } } }
