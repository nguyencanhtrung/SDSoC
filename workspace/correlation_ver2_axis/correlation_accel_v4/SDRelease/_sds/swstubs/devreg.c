/* File: /home/trungnguyen/SDSoC/workspace/correlation_ver2_axis/correlation_accel_v4/SDRelease/_sds/p0/.cf_work/devreg.c */
#include "cf_lib.h"
...
accel_info_t _sds__p0_correlation_accel_v4_0 = {
  .device_id = 1,
...
void _p0_cf_register(int first)
{
  ...
  if (xlnk_init_done == 0) {
    ...
    accel_register(&_sds__p0_correlation_accel_v4_0);
    cf_xlnk_init(first);
  }
...
void _p0_cf_unregister(int last)
{
  ...
  accel_unregister(&_sds__p0_correlation_accel_v4_0);
  xlnkClose(last,NULL);
}
