/* File: C:/xup/SDSoC/labs/lab3a/SDDebug/_sds/p0/.cf_work/devreg.c */
#include "cf_lib.h"
...
accel_info_t _sds__p0_sharpen_filter_0 = {
  .device_id = 4,
...
accel_info_t _sds__p0_sobel_filter_0 = {
  .device_id = 5,
...
void _p0_cf_register(int first)
{
  ...
  if (xlnk_init_done == 0) {
    ...
    axi_dma_simple_register(&_p0_dm_3);
    accel_register(&_sds__p0_sharpen_filter_0);
    accel_register(&_sds__p0_sobel_filter_0);
    cf_xlnk_init(first);
  }
...
void _p0_cf_unregister(int last)
{
  ...
  axi_dma_simple_unregister(&_p0_dm_3);
  accel_unregister(&_sds__p0_sharpen_filter_0);
  accel_unregister(&_sds__p0_sobel_filter_0);
  xlnkClose(last,NULL);
}
