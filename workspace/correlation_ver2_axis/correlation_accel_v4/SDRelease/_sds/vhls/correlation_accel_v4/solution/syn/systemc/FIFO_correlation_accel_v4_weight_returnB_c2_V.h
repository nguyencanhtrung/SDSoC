...
#ifndef FIFO_correlation_accel_v4_weight_returnB_c2_V_HH_
#define FIFO_correlation_accel_v4_weight_returnB_c2_V_HH_

#include <systemc>
using namespace std;
SC_MODULE(FIFO_correlation_accel_v4_weight_returnB_c2_V) {
    static const unsigned int DATA_WIDTH = 32;
    static const unsigned int ADDR_WIDTH = 2;
    static const unsigned int FIFO_correlation_accel_v4_weight_returnB_c2_V_depth = 3;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[FIFO_correlation_accel_v4_weight_returnB_c2_V_depth];
    ...
    SC_CTOR(FIFO_correlation_accel_v4_weight_returnB_c2_V) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < FIFO_correlation_accel_v4_weight_returnB_c2_V_depth; i++) {
    ...
    ~FIFO_correlation_accel_v4_weight_returnB_c2_V() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (FIFO_correlation_accel_v4_weight_returnB_c2_V_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < FIFO_correlation_accel_v4_weight_returnB_c2_V_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (FIFO_correlation_accel_v4_weight_returnB_c2_V_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > FIFO_correlation_accel_v4_weight_returnB_c2_V_depth) {
...
#endif //FIFO_correlation_accel_v4_weight_returnB_c2_V_HH_
