...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.M00_HAS_REGSLICE {1} CONFIG.M01_HAS_REGSLICE {1} CONFIG.M02_HAS_REGSLICE {1} CONFIG.M03_HAS_REGSLICE {1} CONFIG.M04_HAS_REGSLICE {1} CONFIG.M05_HAS_REGSLICE {1} CONFIG.NUM_MI {6} CONFIG.NUM_SI {1} CONFIG.S00_HAS_REGSLICE {1} CONFIG.STRATEGY {2}  ] $axi_interconnect_M_AXI_GP0
  ...
  set_property -dict [ list CONFIG.M00_HAS_DATA_FIFO {2} CONFIG.M00_HAS_REGSLICE {1} CONFIG.NUM_MI {1} CONFIG.NUM_SI {2} CONFIG.S00_HAS_DATA_FIFO {2} CONFIG.S00_HAS_REGSLICE {1} CONFIG.S01_HAS_DATA_FIFO {2} CONFIG.S01_HAS_REGSLICE {1} CONFIG.STRATEGY {2}  ] $axi_interconnect_S_AXI_HP1
  ...
  set_property -dict [ list CONFIG.M_TDATA_NUM_BYTES {4} CONFIG.S_TDATA_NUM_BYTES {8}  ] $axis_dwc_datamover_0_txd_0

  # Create instance: axis_dwc_datamover_1_txd_0, and set properties
  set axis_dwc_datamover_1_txd_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwc_datamover_1_txd_0 ]
  set_property -dict [ list CONFIG.M_TDATA_NUM_BYTES {4} CONFIG.S_TDATA_NUM_BYTES {8}  ] $axis_dwc_datamover_1_txd_0

  # Create instance: axis_dwc_datamover_2_rxd_0, and set properties
  set axis_dwc_datamover_2_rxd_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwc_datamover_2_rxd_0 ]
  set_property -dict [ list CONFIG.M_TDATA_NUM_BYTES {8} CONFIG.S_TDATA_NUM_BYTES {4}  ] $axis_dwc_datamover_2_rxd_0

  # Create instance: axis_dwc_datamover_3_rxd_0, and set properties
  set axis_dwc_datamover_3_rxd_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwc_datamover_3_rxd_0 ]
  set_property -dict [ list CONFIG.M_TDATA_NUM_BYTES {8} CONFIG.S_TDATA_NUM_BYTES {4}  ] $axis_dwc_datamover_3_rxd_0
  ...
  # Create instance: correlation_accel_v2_0_if, and set properties
  set correlation_accel_v2_0_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_accelerator_adapter:2.1 correlation_accel_v2_0_if ]
  set_property -dict [ list CONFIG.C_INPUT_SCALAR_0_WIDTH {32} CONFIG.C_INPUT_SCALAR_1_WIDTH {32} CONFIG.C_N_INPUT_ARGS {0} CONFIG.C_N_INPUT_SCALARS {2} CONFIG.C_N_OUTPUT_ARGS {0}  ] $correlation_accel_v2_0_if

  # Create instance: correlation_accel_v2_1, and set properties
  set correlation_accel_v2_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:correlation_accel_v2:1.0 correlation_accel_v2_1 ]

  # Create instance: correlation_accel_v2_1_if, and set properties
  set correlation_accel_v2_1_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_accelerator_adapter:2.1 correlation_accel_v2_1_if ]
  set_property -dict [ list CONFIG.C_INPUT_SCALAR_0_WIDTH {32} CONFIG.C_INPUT_SCALAR_1_WIDTH {32} CONFIG.C_N_INPUT_ARGS {0} CONFIG.C_N_INPUT_SCALARS {2} CONFIG.C_N_OUTPUT_ARGS {0}  ] $correlation_accel_v2_1_if
  ...
  set_property -dict [ list CONFIG.c_dlytmr_resolution {1250} CONFIG.c_include_mm2s {1} CONFIG.c_include_mm2s_dre {1} CONFIG.c_include_mm2s_sf {1} CONFIG.c_include_s2mm {0} CONFIG.c_include_sg {0} CONFIG.c_m_axi_mm2s_data_width {64} CONFIG.c_m_axis_mm2s_tdata_width {64} CONFIG.c_mm2s_burst_size {64} CONFIG.c_sg_length_width {23}  ] $datamover_1

  # Create instance: datamover_2, and set properties
  set datamover_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 datamover_2 ]
  set_property -dict [ list CONFIG.c_dlytmr_resolution {1250} CONFIG.c_include_mm2s {0} CONFIG.c_include_s2mm {1} CONFIG.c_include_s2mm_dre {1} CONFIG.c_include_s2mm_sf {1} CONFIG.c_include_sg {0} CONFIG.c_m_axi_s2mm_data_width {64} CONFIG.c_s2mm_burst_size {64} CONFIG.c_s_axis_s2mm_tdata_width {64} CONFIG.c_sg_length_width {23}  ] $datamover_2

  # Create instance: datamover_3, and set properties
  set datamover_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 datamover_3 ]
  set_property -dict [ list CONFIG.c_dlytmr_resolution {1250} CONFIG.c_include_mm2s {0} CONFIG.c_include_s2mm {1} CONFIG.c_include_s2mm_dre {1} CONFIG.c_include_s2mm_sf {1} CONFIG.c_include_sg {0} CONFIG.c_m_axi_s2mm_data_width {64} CONFIG.c_s2mm_burst_size {64} CONFIG.c_s_axis_s2mm_tdata_width {64} CONFIG.c_sg_length_width {23}  ] $datamover_3
...
CONFIG.PCW_USE_S_AXI_ACP {0} CONFIG.PCW_USE_S_AXI_HP0 {1} \
CONFIG.PCW_USE_S_AXI_HP1 {1} CONFIG.PCW_WDT_PERIPHERAL_CLKSRC {CPU_1X} \
CONFIG.PCW_WDT_PERIPHERAL_DIVISOR0 {1} CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0} \
  ...
  set_property -dict [ list CONFIG.NUM_PORTS {4}  ] $xlconcat

  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M00_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M00_AXI] [get_bd_intf_pins correlation_accel_v2_0_if/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M01_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M01_AXI] [get_bd_intf_pins correlation_accel_v2_1_if/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M02_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M02_AXI] [get_bd_intf_pins datamover_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M03_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M03_AXI] [get_bd_intf_pins datamover_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M04_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M04_AXI] [get_bd_intf_pins datamover_2/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M05_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M05_AXI] [get_bd_intf_pins datamover_3/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_S_AXI_HP1_M00_AXI [get_bd_intf_pins axi_interconnect_S_AXI_HP1/M00_AXI] [get_bd_intf_pins ps7/S_AXI_HP1]
  connect_bd_intf_net -intf_net axis_dwc_datamover_0_txd_0_M_AXIS [get_bd_intf_pins axis_dwc_datamover_0_txd_0/M_AXIS] [get_bd_intf_pins correlation_accel_v2_1/in_indices]
  connect_bd_intf_net -intf_net axis_dwc_datamover_1_txd_0_M_AXIS [get_bd_intf_pins axis_dwc_datamover_1_txd_0/M_AXIS] [get_bd_intf_pins correlation_accel_v2_0/in_indices]
  connect_bd_intf_net -intf_net axis_dwc_datamover_2_rxd_0_M_AXIS [get_bd_intf_pins axis_dwc_datamover_2_rxd_0/M_AXIS] [get_bd_intf_pins datamover_2/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axis_dwc_datamover_3_rxd_0_M_AXIS [get_bd_intf_pins axis_dwc_datamover_3_rxd_0/M_AXIS] [get_bd_intf_pins datamover_3/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net correlation_accel_v2_0_out_correlation [get_bd_intf_pins axis_dwc_datamover_2_rxd_0/S_AXIS] [get_bd_intf_pins correlation_accel_v2_0/out_correlation]
  connect_bd_intf_net -intf_net correlation_accel_v2_1_if_AP_CTRL [get_bd_intf_pins correlation_accel_v2_1/ap_ctrl] [get_bd_intf_pins correlation_accel_v2_1_if/AP_CTRL]
  connect_bd_intf_net -intf_net correlation_accel_v2_1_out_correlation [get_bd_intf_pins axis_dwc_datamover_3_rxd_0/S_AXIS] [get_bd_intf_pins correlation_accel_v2_1/out_correlation]
  ...
  connect_bd_intf_net -intf_net datamover_1_M_AXIS_MM2S [get_bd_intf_pins axis_dwc_datamover_1_txd_0/S_AXIS] [get_bd_intf_pins datamover_1/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net datamover_1_M_AXI_MM2S [get_bd_intf_pins axi_interconnect_S_AXI_HP1/S00_AXI] [get_bd_intf_pins datamover_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net datamover_2_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_S_AXI_HP0/S01_AXI] [get_bd_intf_pins datamover_2/M_AXI_S2MM]
  connect_bd_intf_net -intf_net datamover_3_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_S_AXI_HP1/S01_AXI] [get_bd_intf_pins datamover_3/M_AXI_S2MM]
  ...
  connect_bd_net -net clkid2 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M04_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M05_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP0/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP1/ACLK] [get_bd_pins axi_interconnect_S_AXI_HP1/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP1/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_HP1/S01_ACLK] [get_bd_pins axis_dwc_datamover_0_txd_0/aclk] [get_bd_pins axis_dwc_datamover_1_txd_0/aclk] [get_bd_pins axis_dwc_datamover_2_rxd_0/aclk] [get_bd_pins axis_dwc_datamover_3_rxd_0/aclk] [get_bd_pins correlation_accel_v2_0/ap_clk] [get_bd_pins correlation_accel_v2_0_if/aclk] [get_bd_pins correlation_accel_v2_0_if/s_axi_aclk] [get_bd_pins correlation_accel_v2_1/ap_clk] [get_bd_pins correlation_accel_v2_1_if/aclk] [get_bd_pins correlation_accel_v2_1_if/s_axi_aclk] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_mm2s_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins datamover_2/m_axi_s2mm_aclk] [get_bd_pins datamover_2/s_axi_lite_aclk] [get_bd_pins datamover_3/m_axi_s2mm_aclk] [get_bd_pins datamover_3/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK2] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK] [get_bd_pins ps7/S_AXI_HP1_ACLK]
  ...
  connect_bd_net -net correlation_accel_v2_1_if_ap_iscalar_0_dout [get_bd_pins correlation_accel_v2_1/number_of_days] [get_bd_pins correlation_accel_v2_1_if/ap_iscalar_0_dout]
  connect_bd_net -net correlation_accel_v2_1_if_ap_iscalar_1_dout [get_bd_pins correlation_accel_v2_1/number_of_indices] [get_bd_pins correlation_accel_v2_1_if/ap_iscalar_1_dout]
  connect_bd_net -net correlation_accel_v2_1_if_aresetn [get_bd_pins correlation_accel_v2_1/ap_rst_n] [get_bd_pins correlation_accel_v2_1_if/aresetn]
  connect_bd_net -net datamover_0_mm2s_introut [get_bd_pins datamover_0/mm2s_introut] [get_bd_pins xlconcat/In0]
  connect_bd_net -net datamover_1_mm2s_introut [get_bd_pins datamover_1/mm2s_introut] [get_bd_pins xlconcat/In1]
  connect_bd_net -net datamover_2_s2mm_introut [get_bd_pins datamover_2/s2mm_introut] [get_bd_pins xlconcat/In2]
  connect_bd_net -net datamover_3_s2mm_introut [get_bd_pins datamover_3/s2mm_introut] [get_bd_pins xlconcat/In3]
  connect_bd_net -net proc_sys_reset_2_interconnect_aresetn [get_bd_pins axi_interconnect_M_AXI_GP0/ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M05_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/S01_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP1/ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP1/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP1/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP1/S01_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_dwc_datamover_0_txd_0/aresetn] [get_bd_pins axis_dwc_datamover_1_txd_0/aresetn] [get_bd_pins axis_dwc_datamover_2_rxd_0/aresetn] [get_bd_pins axis_dwc_datamover_3_rxd_0/aresetn] [get_bd_pins correlation_accel_v2_0_if/s_axi_aresetn] [get_bd_pins correlation_accel_v2_1_if/s_axi_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins datamover_2/axi_resetn] [get_bd_pins datamover_3/axi_resetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_1/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_ps7_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_2/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_ps7_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_ps7_HP1_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs correlation_accel_v2_1_if/S_AXI/Reg] SEG_correlation_accel_v2_1_if_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40410000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs datamover_1/S_AXI_LITE/Reg] SEG_datamover_1_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x40420000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs datamover_2/S_AXI_LITE/Reg] SEG_datamover_2_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x40430000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs datamover_3/S_AXI_LITE/Reg] SEG_datamover_3_Reg
