...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_interconnect_M_AXI_GP0/ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_HP0/S01_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axis_dwc_datamover_0_txd_0/aresetn] [get_bd_pins axis_dwc_datamover_1_rxd_0/aresetn] [get_bd_pins correlation_accel_v2_0_if/s_axi_aresetn] [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
