...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_net -net proc_sys_reset_1_interconnect_aresetn [get_bd_pins axi_interconnect_M_AXI_GP0/ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M04_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/M05_ARESETN] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ARESETN] [get_bd_pins axi_interconnect_S_AXI_ACP/S03_ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins datamover_2/axi_resetn] [get_bd_pins datamover_3/axi_resetn] [get_bd_pins madd_0_if/m_axis_aresetn] [get_bd_pins madd_0_if/s_axi_aresetn] [get_bd_pins madd_0_if/s_axis_aresetn] [get_bd_pins mmult_0_if/m_axis_aresetn] [get_bd_pins mmult_0_if/s_axi_aresetn] [get_bd_pins mmult_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_1/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_2/Data_MM2S] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_3/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
