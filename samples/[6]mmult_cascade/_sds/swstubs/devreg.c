/* File: /home/trungnguyen/SDSoC/samples/mmult_cascade/_sds/p0/.cf_work/devreg.c */
#include "cf_lib.h"
...
void _p0_cf_register(int first)
{
  ...
  if (xlnk_init_done == 0) {
    ...
    accel_register(&_sds__p0_mmult_accel_1);
    cf_xlnk_init(first);
  }
...
void _p0_cf_unregister(int last)
{
  ...
  accel_unregister(&_sds__p0_mmult_accel_1);
  xlnkClose(last,NULL);
}
