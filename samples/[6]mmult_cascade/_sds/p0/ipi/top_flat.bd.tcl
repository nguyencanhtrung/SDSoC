...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_M_AXIS_RXD_TDATA_WIDTH {64} CONFIG.C_M_AXIS_TDATA_WIDTH {64} CONFIG.C_NUM_MASTER_SLOTS {3} CONFIG.C_NUM_SLAVE_SLOTS {1} CONFIG.C_S_AXIS_TDATA_WIDTH {64} CONFIG.C_S_AXIS_TXD_TDATA_WIDTH {64}  ] $axis_rtr_datamover_0
  ...
  set_property -dict [ list CONFIG.C_AP_IARG_0_DIM_1 {256} CONFIG.C_AP_IARG_0_DWIDTH {32} CONFIG.C_AP_IARG_0_TYPE {1} CONFIG.C_AP_IARG_0_WIDTH {32} CONFIG.C_AP_IARG_1_DIM_1 {256} CONFIG.C_AP_IARG_1_DWIDTH {32} CONFIG.C_AP_IARG_1_TYPE {1} CONFIG.C_AP_IARG_1_WIDTH {32} CONFIG.C_AP_OARG_0_DIM_1 {256} CONFIG.C_AP_OARG_0_DWIDTH {32} CONFIG.C_AP_OARG_0_TYPE {1} CONFIG.C_AP_OARG_0_WIDTH {32} CONFIG.C_M_AXIS_HAS_TKEEP {1} CONFIG.C_M_AXIS_HAS_TSTRB {1} CONFIG.C_M_AXIS_TDATA_WIDTH {64} CONFIG.C_N_INPUT_ARGS {2} CONFIG.C_N_OUTPUT_ARGS {1} CONFIG.C_S_AXIS_TDATA_WIDTH {64}  ] $mmult_accel_0_if
  ...
  set_property -dict [ list CONFIG.C_AP_IARG_0_DIM_1 {256} CONFIG.C_AP_IARG_0_DWIDTH {32} CONFIG.C_AP_IARG_0_TYPE {1} CONFIG.C_AP_IARG_0_WIDTH {32} CONFIG.C_AP_IARG_1_DIM_1 {256} CONFIG.C_AP_IARG_1_DWIDTH {32} CONFIG.C_AP_IARG_1_TYPE {1} CONFIG.C_AP_IARG_1_WIDTH {32} CONFIG.C_AP_OARG_0_DIM_1 {256} CONFIG.C_AP_OARG_0_DWIDTH {32} CONFIG.C_AP_OARG_0_TYPE {1} CONFIG.C_AP_OARG_0_WIDTH {32} CONFIG.C_M_AXIS_HAS_TKEEP {1} CONFIG.C_M_AXIS_HAS_TSTRB {1} CONFIG.C_M_AXIS_TDATA_WIDTH {64} CONFIG.C_N_INPUT_ARGS {2} CONFIG.C_N_OUTPUT_ARGS {1} CONFIG.C_S_AXIS_TDATA_WIDTH {64}  ] $mmult_accel_1_if
...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_intf_net -intf_net axi_interconnect_M_AXI_GP0_M01_AXI [get_bd_intf_pins axi_interconnect_M_AXI_GP0/M01_AXI] [get_bd_intf_pins mmult_accel_1_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axis_rtr_datamover_0_M_AXIS_0 [get_bd_intf_pins axis_rtr_datamover_0/M_AXIS_0] [get_bd_intf_pins mmult_accel_0_if/S_AXIS_1]
  connect_bd_intf_net -intf_net axis_rtr_datamover_0_M_AXIS_1 [get_bd_intf_pins axis_rtr_datamover_0/M_AXIS_1] [get_bd_intf_pins mmult_accel_1_if/S_AXIS_0]
  connect_bd_intf_net -intf_net axis_rtr_datamover_0_M_AXIS_2 [get_bd_intf_pins axis_rtr_datamover_0/M_AXIS_2] [get_bd_intf_pins mmult_accel_1_if/S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net mmult_accel_1_if_M_AXIS_0 [get_bd_intf_pins mmult_accel_0_if/S_AXIS_0] [get_bd_intf_pins mmult_accel_1_if/M_AXIS_0]
  connect_bd_intf_net -intf_net mmult_accel_1_in_A [get_bd_intf_pins mmult_accel_1/in_A] [get_bd_intf_pins mmult_accel_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net mmult_accel_1_in_B [get_bd_intf_pins mmult_accel_1/in_B] [get_bd_intf_pins mmult_accel_1_if/AP_FIFO_IARG_1]
  connect_bd_intf_net -intf_net mmult_accel_1_out_C [get_bd_intf_pins mmult_accel_1/out_C] [get_bd_intf_pins mmult_accel_1_if/AP_FIFO_OARG_0]
  ...
  connect_bd_net -net clkid1 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ACLK] [get_bd_pins axis_rtr_datamover_0/M_AXIS_0_ACLK] [get_bd_pins axis_rtr_datamover_0/M_AXIS_1_ACLK] [get_bd_pins axis_rtr_datamover_0/M_AXIS_2_ACLK] [get_bd_pins axis_rtr_datamover_0/S_AXIS_0_ACLK] [get_bd_pins axis_rtr_datamover_0/m_axis_rxd_aclk] [get_bd_pins axis_rtr_datamover_0/m_axis_rxs_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txc_aclk] [get_bd_pins axis_rtr_datamover_0/s_axis_txd_aclk] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/m_axi_s2mm_aclk] [get_bd_pins datamover_0/m_axi_sg_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins mmult_accel_0/ap_clk] [get_bd_pins mmult_accel_0_if/aclk] [get_bd_pins mmult_accel_0_if/m_axis_aclk] [get_bd_pins mmult_accel_0_if/s_axi_aclk] [get_bd_pins mmult_accel_0_if/s_axis_aclk] [get_bd_pins mmult_accel_1/ap_clk] [get_bd_pins mmult_accel_1_if/aclk] [get_bd_pins mmult_accel_1_if/m_axis_aclk] [get_bd_pins mmult_accel_1_if/s_axi_aclk] [get_bd_pins mmult_accel_1_if/s_axis_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs mmult_accel_1_if/S_AXI/Reg] SEG_mmult_accel_1_if_Reg
