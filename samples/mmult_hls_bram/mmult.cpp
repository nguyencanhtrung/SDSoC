/*
 * SDSoC will transfer array arguments that map onto a bram interface via
 ...
 * Use "#pragma SDS data buffer_depth(A:2)" to set the multibuffer depth to 2
 * 
...
void mmult(float A[A_NROWS*A_NCOLS],
           ...
           float C[A_NROWS*B_NCOLS]) 
{
// SDSoC automatically generates #pragma HLS interface bram port=A,B,C
