...
CONFIG.PCW_WDT_PERIPHERAL_ENABLE {0}  ] $ps7
  ...
  connect_bd_intf_net -intf_net datamover_0_M_AXIS_MM2S [get_bd_intf_pins datamover_0/M_AXIS_MM2S] [get_bd_intf_pins mmult_accel_0_if/S_AXIS_1]
  ...
  connect_bd_intf_net -intf_net datamover_1_M_AXIS_MM2S [get_bd_intf_pins datamover_1/M_AXIS_MM2S] [get_bd_intf_pins mmult_accel_0_if/S_AXIS_0]
  ...
  connect_bd_intf_net -intf_net datamover_2_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_S_AXI_ACP/S02_AXI] [get_bd_intf_pins datamover_2/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net mmult_accel_0_if_M_AXIS_0 [get_bd_intf_pins datamover_2/S_AXIS_S2MM] [get_bd_intf_pins mmult_accel_0_if/M_AXIS_0]
  ...
  connect_bd_net -net acp_axcache_0xF_dout [get_bd_pins acp_axcache_0xF/dout] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_AXI_arcache] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_AXI_awcache]
  connect_bd_net -net clkid0 [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK0]
  connect_bd_net -net clkid1 [get_bd_pins axi_interconnect_M_AXI_GP0/ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M00_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M01_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M02_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/M03_ACLK] [get_bd_pins axi_interconnect_M_AXI_GP0/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/M00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S00_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S01_ACLK] [get_bd_pins axi_interconnect_S_AXI_ACP/S02_ACLK] [get_bd_pins datamover_0/m_axi_mm2s_aclk] [get_bd_pins datamover_0/s_axi_lite_aclk] [get_bd_pins datamover_1/m_axi_mm2s_aclk] [get_bd_pins datamover_1/s_axi_lite_aclk] [get_bd_pins datamover_2/m_axi_s2mm_aclk] [get_bd_pins datamover_2/s_axi_lite_aclk] [get_bd_pins mmult_accel_0/ap_clk] [get_bd_pins mmult_accel_0_if/aclk] [get_bd_pins mmult_accel_0_if/m_axis_aclk] [get_bd_pins mmult_accel_0_if/s_axi_aclk] [get_bd_pins mmult_accel_0_if/s_axis_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7/S_AXI_ACP_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins datamover_0/axi_resetn] [get_bd_pins datamover_1/axi_resetn] [get_bd_pins datamover_2/axi_resetn] [get_bd_pins mmult_accel_0_if/m_axis_aresetn] [get_bd_pins mmult_accel_0_if/s_axi_aresetn] [get_bd_pins mmult_accel_0_if/s_axis_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces datamover_2/Data_S2MM] [get_bd_addr_segs ps7/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_ps7_ACP_DDR_LOWOCM
