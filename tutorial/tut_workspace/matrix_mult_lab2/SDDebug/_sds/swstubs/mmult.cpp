...
void _p0_mmult_0(float in_A[1024], float in_B[1024], float out_C[1024])
{
  ...
  cf_send_i(&(_p0_swinst_mmult_0.in_A), in_A, 1024 * 4, &_p0_request_0);
  cf_send_i(&(_p0_swinst_mmult_0.in_B), in_B, 1024 * 4, &_p0_request_1);

  cf_receive_i(&(_p0_swinst_mmult_0.out_C), out_C, 1024 * 4, &_p0_mmult_0_num_out_C, &_p0_request_2);
