...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name mmult_accel_ap_fadd_7_full_dsp_32
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name mmult_accel_ap_fadd_7_full_dsp_32 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips mmult_accel_ap_fadd_7_full_dsp_32] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files mmult_accel_ap_fadd_7_full_dsp_32.xci]
generate_target {synthesis simulation} [get_files mmult_accel_ap_fadd_7_full_dsp_32.xci]
