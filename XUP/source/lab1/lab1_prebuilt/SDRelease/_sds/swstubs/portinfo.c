/* File: C:/xup/SDSoC/labs/lab1_prebuilt/SDRelease/_sds/p0/.cf_work/portinfo.c */
#include "cf_lib.h"
...
axi_dma_simple_channel_info_t _p0_swinst_madd_0_B_info = {
  .dma_info = &_p0_dm_2,
  .in_use = 0,
  .needs_cache_flush_invalidate = 0
};

axi_dma_simple_channel_info_t _p0_swinst_madd_0_C_info = {
  .dma_info = &_p0_dm_3,
  .in_use = 0,
  .needs_cache_flush_invalidate = 0
};
...
void _p0_cf_framework_open(int first)
{
  ...
  _p0_cf_open_port( &_p0_swinst_madd_0.B.base );
  _p0_cf_open_port( &_p0_swinst_madd_0.C.base );
...
void _p0_cf_framework_close(int last)
{
  ...
  cf_close_i( &_p0_swinst_madd_0.B, NULL);
  cf_close_i( &_p0_swinst_madd_0.C, NULL);
