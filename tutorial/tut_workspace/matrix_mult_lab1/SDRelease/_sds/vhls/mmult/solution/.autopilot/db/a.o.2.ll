; ModuleID = '/home/trungnguyen/SDSoC/tutorial/tut_workspace/matrix_mult_lab1/SDRelease/_sds/vhls/mmult/solution/.autopilot/db/a.o.2.bc'
...
define void @mmult(float* %in_A, float* %in_B, float* %out_C) {
  ...
  call void @llvm.dbg.value(metadata !{float* %in_A}, i64 0, metadata !45), !dbg !49 ; [debug line = 31:18] [debug variable = in_A]
  call void @llvm.dbg.value(metadata !{float* %in_B}, i64 0, metadata !50), !dbg !51 ; [debug line = 32:18] [debug variable = in_B]
  call void @llvm.dbg.value(metadata !{float* %out_C}, i64 0, metadata !52), !dbg !53 ; [debug line = 33:18] [debug variable = out_C]
