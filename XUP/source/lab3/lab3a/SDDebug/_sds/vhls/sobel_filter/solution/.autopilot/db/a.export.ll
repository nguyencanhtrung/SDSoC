...
define i32 @sobel_filter(i8* %input_r, i8* %output_r) nounwind uwtable {
  %buff_C_2_1 = alloca i8
  %buff_C_0_0 = alloca i8
  %buff_C_0_1 = alloca i8
  %buff_C_2_0 = alloca i8
...
.preheader:                                       ; preds = %0, %._crit_edge4
  ...
  %buff_C_0_0_load = load i8* %buff_C_0_0
  %buff_C_0_1_load_1 = load i8* %buff_C_0_1
  %buff_C_2_0_load = load i8* %buff_C_2_0
...
linebuffer_shift_up.exit:                         ; preds = %.preheader.preheader
  %tmp_4 = zext i11 %col_assign_mid2 to i64
  %buff_A_1_addr = getelementptr [1920 x i8]* %buff_A_1, i64 0, i64 %tmp_4
  %buff_A_1_load = load i8* %buff_A_1_addr, align 1
  %buff_A_2_addr = getelementptr [1920 x i8]* %buff_A_2, i64 0, i64 %tmp_4
  store i8 %buff_A_1_load, i8* %buff_A_2_addr, align 1
  %buff_A_0_addr = getelementptr [1920 x i8]* %buff_A_0, i64 0, i64 %tmp_4
...
._crit_edge2_ifconv:                              ; preds = %1, %._crit_edge
  %buff_C_2_2_1 = phi i8 [ %y, %1 ], [ 0, %._crit_edge ]
  %buff_C_2_1_load_1 = load i8* %buff_C_2_1
  ...
  %buff_C_1_2 = select i1 %tmp_3, i8 %buff_C_1_2_1, i8 %buff_C_1_1_load
  %buff_C_0_2 = select i1 %tmp_3, i8 %return_value_1, i8 %buff_C_0_1_load
  %buff_C_2_2 = select i1 %tmp_3, i8 %buff_C_2_2_1, i8 %buff_C_2_1_load_1
  %tmp_10_0_i_cast = zext i8 %buff_C_0_0_load to i9
  %tmp_12_0_1_i = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %buff_C_0_1_load, i1 false)
  %tmp_12_0_1_i_cast = zext i9 %tmp_12_0_1_i to i10
  %tmp_10_0_2_i_cast = zext i8 %buff_C_0_2 to i9
  %x_weight_2_0_2_i = sub i9 %tmp_10_0_2_i_cast, %tmp_10_0_i_cast
  %x_weight_2_0_2_i_cast = sext i9 %x_weight_2_0_2_i to i11
  %p_shl6_i = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %buff_C_1_0_load, i1 false)
  %p_shl6_i_cast = zext i9 %p_shl6_i to i11
  %x_weight_2_1_1_i = sub i11 %x_weight_2_0_2_i_cast, %p_shl6_i_cast
  %tmp_11_1_2_i = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %buff_C_1_2, i1 false)
  %tmp_11_1_2_i_cast = zext i9 %tmp_11_1_2_i to i11
  %x_weight_2_1_2_i = add i11 %x_weight_2_1_1_i, %tmp_11_1_2_i_cast
  %tmp1 = add i9 %tmp_10_0_2_i_cast, %tmp_10_0_i_cast
  %tmp1_cast = zext i9 %tmp1 to i10
  %y_weight_2_1_2_i = add i10 %tmp_12_0_1_i_cast, %tmp1_cast
  %y_weight_2_1_2_i_cast = zext i10 %y_weight_2_1_2_i to i11
  %tmp_10_2_i_cast = zext i8 %buff_C_2_0_load to i11
  %x_weight_2_2_i = sub i11 %x_weight_2_1_2_i, %tmp_10_2_i_cast
  %y_weight_2_2_i = sub i11 %y_weight_2_1_2_i_cast, %tmp_10_2_i_cast
  %p_shl_i = call i9 @_ssdm_op_BitConcatenate.i9.i8.i1(i8 %buff_C_2_1_load_1, i1 false)
  %p_shl_i_cast = zext i9 %p_shl_i to i11
  %y_weight_2_2_1_i = sub i11 %y_weight_2_2_i, %p_shl_i_cast
  %tmp_10_2_2_i_cast = zext i8 %buff_C_2_2 to i11
  %x_weight_2_2_2_i = add i11 %tmp_10_2_2_i_cast, %x_weight_2_2_i
  %y_weight_2_2_2_i = sub i11 %y_weight_2_2_1_i, %tmp_10_2_2_i_cast
  %tmp_i = icmp sgt i11 %x_weight_2_2_2_i, 0
  %tmp_1_i = sub i11 0, %x_weight_2_2_2_i
  %tmp_2_i = select i1 %tmp_i, i11 %x_weight_2_2_2_i, i11 %tmp_1_i
  %tmp_2_i_cast = sext i11 %tmp_2_i to i12
  %tmp_3_i = icmp sgt i11 %y_weight_2_2_2_i, 0
  %tmp_4_i = sub i11 0, %y_weight_2_2_2_i
  %tmp_5_i = select i1 %tmp_3_i, i11 %y_weight_2_2_2_i, i11 %tmp_4_i
  %tmp_5_i_cast = sext i11 %tmp_5_i to i12
  %edge_weight = add i12 %tmp_5_i_cast, %tmp_2_i_cast
  %tmp_7_i = icmp sgt i12 %edge_weight, 200
  %tmp_9_i = icmp slt i12 %edge_weight, 100
  %tmp_8 = trunc i12 %edge_weight to i8
  %phitmp_i = select i1 %tmp_7_i, i8 -1, i8 0
  %tmp_5 = or i1 %tmp_7_i, %tmp_9_i
  %edge_val = select i1 %tmp_5, i8 %phitmp_i, i8 %tmp_8
  %tmp_s = icmp ne i11 %col_assign_mid2, 0
  %or_cond = and i1 %tmp_1, %tmp_s
...
._crit_edge4:                                     ; preds = %2, %._crit_edge2_ifconv
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str2, i32 %tmp_2) nounwind
...
.preheader.preheader:                             ; preds = %.preheader
  ...
  %tmp_3 = icmp ult i11 %col_assign_mid2, -128
  br i1 %tmp_3, label %linebuffer_shift_up.exit, label %._crit_edge
...
entry:
  ...
  %empty_5 = zext i1 %1 to i9
  %empty_6 = shl i9 %empty, 1
