...
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'gmem32'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler correlation_accel_v1_gmem32_m_axi
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_in_indices \
    op interface \
    ports { in_indices { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_out_correlation \
    op interface \
    ports { out_correlation { I 32 vector } } \
} "
}
