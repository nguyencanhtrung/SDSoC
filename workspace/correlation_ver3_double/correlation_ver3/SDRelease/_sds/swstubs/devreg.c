/* File: /home/trungnguyen/SDSoC/workspace/correlation_ver3_double/correlation_ver3/SDRelease/_sds/p0/.cf_work/devreg.c */
#include "cf_lib.h"
...
axi_dma_simple_info_t _p0_datamover_3 = {
  .device_id = 3,
...
accel_info_t _sds__p0_correlation_accel_v2_0 = {
  .device_id = 4,
...
accel_info_t _sds__p0_correlation_accel_v2_1 = {
  .device_id = 5,
...
void _p0_cf_register(int first)
{
  ...
  if (xlnk_init_done == 0) {
    ...
    axi_dma_simple_register(&_p0_datamover_3);
    accel_register(&_sds__p0_correlation_accel_v2_0);
    accel_register(&_sds__p0_correlation_accel_v2_1);
    cf_xlnk_init(first);
  }
...
void _p0_cf_unregister(int last)
{
  ...
  axi_dma_simple_unregister(&_p0_datamover_3);
  accel_unregister(&_sds__p0_correlation_accel_v2_0);
  accel_unregister(&_sds__p0_correlation_accel_v2_1);
  xlnkClose(last,NULL);
}
