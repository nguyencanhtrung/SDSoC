                    ...
                    const float allowErrorThreshold)
{
    int i;
    int errorCount_in = 0;
    Xil_DCacheInvalidateRange((unsigned int)hw_result,  number_of_result * 4);
    Xil_DCacheInvalidateRange((unsigned int)sw_result,  number_of_result * 4);
...
int main(int argc, char* argv[])
{
    ...
    Xil_DCacheFlushRange((unsigned int)indices_buff, all_indices_size);
    //Xil_DCacheFlush();
